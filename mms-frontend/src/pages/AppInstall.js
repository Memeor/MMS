...
export class AppInstall extends Component {
    ...
    change = e =>{
        ...
        this.setState({
            valid: !(this.state.error.emailError || !validator.isLength(this.state.name1, 1,50) || !validator.isLength(this.state.address, 1, 200) || ! validator.isLength(this.state.description, 1, 10000))
        });
